#it's working PERFECTLY FINE SOME EXCEPTIONS WITH A ROGUE NOTe THAT'S NOT BLACK BUT IT'S DASHED BLACK SO WE HAVE TO COMPARE THAT TOO!!!!!
#THIS IS THE ISSUE
#THEN WE WORK ON THE POINTS PART FOR THE DASHED
#THEN WE DO SHARP FLAT
#AND DONE
...
def process_line(input_y, img_array, width, difference_between_lines_for_line_drawing, difference_between_lines, line_height):
    ...
    #WE'RE MAKING IT ADD STUFF TO BLACK NOTES IN GROUPS AND THEN IN ROWS 
...
def extract_highlighted_lines_and_columns_from_image(image_path, threshold=2/3):
    ...
    #we have to do the vertical processing after here
